...
export const PersonaForm = () => {
  ...
  // creating a copy functoin
  const handleCopy = async () => {
    try {
      await navigator.clipboard.writeText(generatePrompt)
      setCopied(true)
      // copied then wapis false kardo taki utni der me show ho jaye woh
      setTimeout(() => setCopied(false), 2000 )

    } catch (err) {
     console.log('Failled to copy:', err) 
    }
  }

  const rolePresets = ['Expert', 'Friend', 'Teacher', 'Code Reviewer', 'Mentor', 'Storyteller', 'Creative','Interviewer', 'Therapist'];
  const tonePresets = ['Sarcastic', 'Witty', 'Formal', 'Helpful', 'Gen Z',"Funny", 'Playful', 'Direct', 'Chill', 'Serious', 'Casual'];
  ...
  return (
    ...
    <div className=" flex flex-col max-w-4xl md:max-w-6xl md:border sm:p-4 p-2 rounded-sm md:rounded-2xl border-neutral-700 mb-6 mx-auto mt-8 lg:mt-18 ">
      {/* main grid thing  */}
      <div
      className=' rounded-2xl grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 border-neutral-600 p-2 md:p-4 max-w-6xl min-h-[500px] w-full '
      >
        {/* first div */}
        <div className="bg-neutral-900/30 border-neutral-800 border backdrop-blur-md rounded-lg p-4 md:p-6 shadow-md selection:bg-neutral-100 selection:text-black  ">
          ...
          <div className="rounded-lg py-2 ">
            ...
            className="py-2 px-2 text-base ">
              What you want your LLM to call you ?
            </label>
        ...
        {/* second div */}
        <div className="bg-neutral-900/30 border-neutral-800 border backdrop-blur-md rounded-lg p-6 shadow-md selection:bg-neutral-100 selection:text-black   ">
          <h2 className="text-neutral-300 mb-4 pl-2 text-2xl font-bold font-mono">
      ...
      <div className="max-w-6xl w-full mt-6 flex flex-col justify-center items-center selection:bg-neutral-100 selection:text-black  ">
        ...
        <div className="w-84 md:w-4xl   ">
          <label htmlFor="output" 
          className="block text-center md:text-start mb-2 px-1 text-neutral-200 font-mono text-lg ">
            Master Prompt
          </label>
          ...
          <div className="relative  ">
            ...
            className='w-full px-2 py-2 pr-12 border border-neutral-500 bg-black/40 rounded-lg text-neutral-400 font-mono scrollbar-hidden resize-none focus:outline-none selection:bg-neutral-100 selection:text-black '
            />
            ...
            {copied && (
              ...
              className="absolute -top-10 -right-2 text-sm px-2 py-1 rounded-lg border text-neutral-200 shadow-lg transition-opacity duration-200 selection:bg-neutral-100 selection:text-neutral-950">
                Copied!!
              </motion.div>
            )}
        ...
        className=" md:w-52 border my-2 md:my-4 border-neutral-500 py-1 md:py-2 px-2 md:px-6 text-base md:text-lg  bg-neutral-200 text-neutral-900 font-bold rounded-sm shadow-lg hover:text-black cursor-pointer transition-colors duration-100 disabled:bg-neutral-50 "
        >
